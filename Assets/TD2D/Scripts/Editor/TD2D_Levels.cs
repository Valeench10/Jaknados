...
public class TD2D_Levels : EditorWindow
{
	...
	private void LevelDescriptionGUI()
	{
		if (myState == MyState.LevelDescription && mySubState.Contains(MySubState.LevelDescription))
		{
			...
			{
				PrefabUtility.ReplacePrefab(inspectors.levelDescription.gameObject, PrefabUtility.GetPrefabParent(inspectors.levelDescription.gameObject), ReplacePrefabOptions.ConnectToPrefab);
			}
